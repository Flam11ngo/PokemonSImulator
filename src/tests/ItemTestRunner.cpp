...
bool runSingleItemTestWithContext(ItemType itemType, Pokemon* self, Pokemon* other, Battle& battle, std::ostream& out, std::ostream& err) {
    ...
    switch (itemType) {
        ...
        case ItemType::BerryJuice: {
            ...
            item.executeTrigger(ItemTrigger::OnDamage, self, other, battle.getContext(), &ctx);
        ...
        case ItemType::LumBerry: {
            ...
            item.executeTrigger(ItemTrigger::OnStatus, self, other, battle.getContext());
        ...
        case ItemType::BlackSludge: {
            ...
            int before = self->getCurrentHP();
            item.executeTrigger(ItemTrigger::OnTurnEnd, self, other, battle.getContext());
        ...
        case ItemType::ShellBell: {
            ...
            item.executeTrigger(ItemTrigger::OnDealDamage, self, other, battle.getContext(), &ctx);
        ...
        case ItemType::PowerHerb: {
            self->holdItem(itemType);
            item.executeTrigger(ItemTrigger::OnAttack, self, other, battle.getContext());
        ...
        case ItemType::WhiteHerb: {
            ...
            item.executeTrigger(ItemTrigger::OnStatChange, self, other, battle.getContext());
